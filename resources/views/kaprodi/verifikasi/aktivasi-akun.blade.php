    ...
    <table class=""style="width: 100% !important;" id="table">
        ...
        <tbody>
          <tr>
            ...
            <td>SIX-46-01</td>
              <td><a style="color:white; padding:4px; border:none; background-color:green;">Aktif</a></td>
          ...
          <tr>
            ...
            <td>salamalfis</td>
            <td>SIX-47-01</td>
             <td><a style="color:white; padding:4px; border:none; background-color:red;">Tidak Aktif</a></td>
              <td>
              <div style="display: inline;">
             <button class="fa-solid fa-square-check"  style="color:green; border:none; background-color:white;">
