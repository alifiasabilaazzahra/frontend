@include('doswal/dashboard/template/header')
          ...
          <div class="col-16">
              ...
              <div class="card">
                ...
                <thead>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">KIRIM PESAN</th>
                </tr>
              </thead>
                  <tbody>
          <tr>
            ...
            <td>SI-45-01</td>
             <td><a class="btn" style="color:white; padding:4px; border:none; background-color:red;">25%</a></td>
            
            <td>
              <div style="display: inline;">
              
              <button class="fa-solid fa-paper-plane" style=" border:none;background-color:white; color:#2684FF;">
...
@extends('doswal/dashboard/template/footer')